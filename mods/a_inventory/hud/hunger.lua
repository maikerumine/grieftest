...
--[[
if minetest.get_modpath("mm") ~= nil then
...
overwrite("mobs:rotten_flesh", 2,"",-6)
overwrite("mobs:chicken_egg_fried", 3)
overwrite("mobs:mutton_cooked", 6)
overwrite("mobs:mutton_raw", 2)
overwrite("mobs:pork_raw",  2)
overwrite("mobs:pork_cooked", 4)
overwrite("mobs:beef_raw", 3)
overwrite("mobs:beef_cooked", 9)
overwrite("mobs:cheese", 4)
overwrite("mobs:rat_cooked", 2)
