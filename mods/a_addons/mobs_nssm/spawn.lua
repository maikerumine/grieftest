...
mobs:spawn_specific("nssm:crocodile", {"default:water_source"}, {"air"},
	0, 20, 60, 7000, 1, -31000, 2)
mobs:spawn_specific("nssm:octopus", {"default:water_source"}, {"default:water_source"},
	0, 20, 60, 40000, 1, -31000, 0)
...
-- SKY
--mobs:spawn_specific("nssm:moonheron", {"air"}, {"air"},0, 10, 100, 160000, 2, 60, 70)
