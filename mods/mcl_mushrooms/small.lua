local on_place = function(itemstack, placer, pointed_thing)
	...
	if (soil_node.name == "default:podzol" or soil_node.name == "default:podzol_snow" or soil_node.name == "default:mycelium" or soil_node == "default:mycelium_snow") or
...
minetest.register_craftitem("mcl_mushrooms:mushroom_stew", {
	...
	on_place = minetest.item_eat(6, "default:bowl"),
	on_secondary_use = minetest.item_eat(6, "default:bowl"),
...
minetest.register_craft({
	...
	recipe = {'default:bowl', 'mcl_mushrooms:mushroom_brown', 'mcl_mushrooms:mushroom_red'}
})
