...
minetest.override_item("default:desert_sand", {
	...
	soil = {
		base = "default_sand.png^[colorize:#FFCC33:152",
...
minetest.register_node("farming:desert_sand_soil", {
	...
	tiles = {"farming_desert_sand_soil.png", "default_sand.png^[colorize:#FFCC33:152"},
...
minetest.register_node("farming:desert_sand_soil_wet", {
	...
	drop = "default:desert_sand",
	tiles = {"farming__sand_soil_wet.png", "farming_desert_sand_soil_wet_side.png"},
