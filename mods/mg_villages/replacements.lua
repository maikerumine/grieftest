...
mg_villages.replacements_taoki = function( housetype, pr, replacements )
      ...
      -- the main body of the houses in the .mts files is made out of wood
		...
		'hardenedclay:hardened_clay_Black', 'hardenedclay:hardened_clay_Red','hardenedclay:hardened_clay_Blue', 'hardenedclay:hardened_clay_Purple','hardenedclay:hardened_clay_Yellow','hardenedclay:hardened_clay_Gray',
